        ...
        gastosHTML += 
            `<div class="card text-center w-60 m-auto mt-3 shadow p-2">
                <div class="row">
                    ...
                    <div class="col">
                        <button class="btn btn-danger" onclick="eliminarGasto(${index})"><i class="bi bi-trash3-fill"></i></button>
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editarGasto" onclick="mostrarGasto(${index})"><i class="bi bi-pencil-square"></i></button>
                    </div>
                </div>  
            </div>`;
...
var actualizarGasto = document.getElementById("actualizar");
actualizarGasto.onclick = () => {
...
const reset = () => {
    Swal.fire({
        title: "¿Seguro de Eliminar el Presupuesto?",
